...
![Phase 1 — Step 1: Navigate to Entra ID Custom Domain Names](screenshots/Phase1-Step1.png)
...
![Phase 1 — Step 2: Add cloudidlab.net as Custom Domain](screenshots/Phase1-Step2.png)
...
![Phase 1 — Step 3: Retrieve TXT Verification Record](screenshots/Phase1-Step3.png)
...
![Phase 1 — Step 4: Add TXT Record at GoDaddy](screenshots/Phase1-Step4.png)
...
![Phase 1 — Step 5: Domain Verified — Notification Confirmed](screenshots/Phase1-Step5.png)
...
![Phase 1 — Step 6: Domain Properties — Verified Status](screenshots/Phase1-Step6.png)
...
![Phase 1 — Step 7: Make Primary — Confirmation Dialog](screenshots/Phase1-Step7.png)
...
![Phase 1 — Step 8: Primary Domain Set — Confirmed](screenshots/Phase1-Step8.png)
...
![Phase 2 — Step 1: Open Active Directory Domains and Trusts on DC1](screenshots/Phase2-Step1.png)
...
![Phase 2 — Step 2: Add cloudidlab.net as Alternative UPN Suffix](screenshots/Phase2-Step2.png)
...
![Phase 2 — Step 3: Verify Updated UPN Suffixes in PowerShell](screenshots/Phase2-Step3.png)
...
![Phase 3 — Step 1: Download Connect Sync Agent from Entra Admin Center](screenshots/Phase3-Step1.png)
...
![Phase 3 — Step 2: AzureADConnect.msi Downloaded Successfully](screenshots/Phase3-Step2.png)
...
![Phase 3 — Step 3: Express Settings — corp.local Non-Routable Warning](screenshots/Phase3-Step3.png)
...
![Phase 3 — Step 4: Required Components — All Defaults](screenshots/Phase3-Step4.png)
...
![Phase 3 — Step 5: User Sign-In — Password Hash Sync + Seamless SSO](screenshots/Phase3-Step5.png)
...
![Phase 3 — Step 6: Connect to Microsoft Entra ID](screenshots/Phase3-Step6.png)
...
![Phase 3 — Step 7: Connect Directories — corp.local Detected](screenshots/Phase3-Step7.png)
...
![Phase 3 — Step 8: AD Forest Account — Create New AD Account](screenshots/Phase3-Step8.png)
...
![Phase 3 — Step 9: corp.local Connected — Green Tick Confirmed](screenshots/Phase3-Step9.png)
...
![Phase 3 — Step 10: Entra Sign-In Config — UPN Suffix Mapping](screenshots/Phase3-Step10.png)
...
![Phase 3 — Step 11: Uniquely Identifying Users](screenshots/Phase3-Step11.png)
...
![Phase 3 — Step 12: Optional Features — Password Hash Sync Only](screenshots/Phase3-Step12.png)
...
![Phase 3 — Step 13: Ready to Configure — Final Summary](screenshots/Phase3-Step13.png)
...
![Phase 4 — Step 1: Entra ID Users — 3 Synced Users Confirmed](screenshots/Phase4-Step1.png)
...
![Phase 4 — Step 2: John Smith Profile — Full Hybrid Identity Data](screenshots/Phase4-Step2.png)
...
![Phase 4 — Step 3: Sync Service Manager — 6 Successful Operations](screenshots/Phase4-Step3.png)
...
![Phase 4 — Step 4: Entra Connect Dashboard — Sync Enabled, PHS, SSO](screenshots/Phase4-Step4.png)
...
![Phase 4 — Step 5: Connect Health — Zero Sync Errors (P2 Feature)](screenshots/Phase4-Step5.png)
